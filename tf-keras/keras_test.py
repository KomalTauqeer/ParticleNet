...
def main():
    ...
    #file_to_eval = 'preprocessing/converted/test/Test_{}_{}_{}_0.awkd'.format(region,sample, year)
    ...
    plot_output_score(predicted_scores, true_scores, outdir+'/'+srcfile)
    plot_confusion_matrix(predicted_scores, true_scores, outdir+'/'+srcfile)
    compute_ROC_curve(predicted_scores, true_scores, outdir+'/'+srcfile)
